class CfgPatches
{
	class BDA_CMA_Uniforms
	{
		...
		units[]={"BDA_CMA_Tropic", "BDA_CMA_Tropic_Rolled", "BDA_CMA_Tropic_Top", "BDA_VD_Tropic"};
		weapons[]={};
		magazines[]={};
		ammo[]={};
		requiredVersion=0.1;
...
class CfgVehicles
{
	...
	class BDA_CMA_Tropic: B_Soldier_F
	{
		...
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_CMA_Uniform_Tropic.paa"
		};
	...
	class BDA_CMA_Tropic_Top: B_Soldier_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_CMA_Tropic_Top.paa",
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_CMA_Uniform_Tropic.paa"
		};
		class ItemInfo: UniformItem
		{
	...
	class BDA_VD_Tropic: I_E_Man_Base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_VD_Uniform_Tropic_CO.paa"
		};
	};
...
//------------------------------------------------------------------// Uniform Tropic.
	...
	class BDA_CMA_MC32L_Tropic: V_CarrierRigKBT_01_light_base_F
	{
		author="Schlopp";
		scope=2;
		picture="BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\UI\icon_V_CarrierRigKBT_01_light_Olive_F_ca.paa";
		model="\A3\Characters_F_Enoch\Vests\V_CarrierRigKBT_01_light_F.p3d";
		displayName="MC32L Body Armor (Tropic)";
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_CMA_MC32_Tropic_CO.paa"
		};
	};
	class BDA_CMA_MC32H_Tropic: V_CarrierRigKBT_01_heavy_base_F
	{
		author="Schlopp";
		scope=2;
		picture="BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\UI\icon_V_CarrierRigKBT_01_heavy_Olive_F_ca.paa";
	...
	class BDA_VD_MC32L_Tropic: V_CarrierRigKBT_01_light_base_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_VD_MC32_Tropic_CO.paa"
		};
	};
	...
	class BDA_CMA_CH230_Tropic: H_HelmetB
	{
		...
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_CMA_CH230_Tropic_CO.paa"
		};
	...
	class BDA_VD_CH230_Tropic: H_HelmetB
	{
		...
		hiddenSelectionsTextures[]=
		{
			"BDA_Units\BDA_FAC_AUX\BDA_CMA\BDA_CMA_Uniforms\data\BDA_VD_CH230_Tropic_CO.paa"
		};
		class ItemInfo: HeadgearItem
		{
			mass=40;

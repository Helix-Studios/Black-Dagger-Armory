...
class CfgVehicles {
	...
	class BDA_UNSC_D77_TC_Pelican_VTOL: Splits_Pelican_base {
		scope = 2;
		scopeCurator = 2;
		side = 1;
		dlc="BDA";
		...
		showAllTargets = 4; //LockYes, show targets from all sensors  https://community.bistudio.com/wiki/File:showAllTargets.png
